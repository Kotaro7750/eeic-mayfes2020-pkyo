const stageList = [
  {
    id: 'go-straight',
    title: 'まっすぐ<ruby>進<rp>(</rp><rt>すす</rt><rp>)</rp></ruby>もう！',
    message: 'ブロックを<ruby>動<rp>(</rp><rt>うご</rt><rp>)</rp></ruby>かして、キャラクターを<ruby>階段<rp>(</rp><rt>かいだん</rt><rp>)</rp></ruby>へ<ruby>動<rp>(</rp><rt>うご</rt><rp>)</rp></ruby>かそう！',
  },
  {
    id: 'turn',
    title: '<ruby>曲<rp>(</rp><rt>ま</rt><rp>)</rp></ruby>がってみよう！',
